...
require (
	...
	k8s.io/cli-runtime v0.0.0-20220613201155-e6102818c52f
...
require (
	...
	k8s.io/api v0.0.0-20220613074849-6b0201da8019 // indirect
	k8s.io/apimachinery v0.0.0-20220613074648-b90ea24d2fd6 // indirect
...
replace (
	...
	k8s.io/cli-runtime => k8s.io/cli-runtime v0.0.0-20220613201155-e6102818c52f
