...
require (
	...
	k8s.io/cli-runtime v0.0.0-20240118214800-f0b7409cd6e5
...
require (
	...
	k8s.io/apimachinery v0.0.0-20240118211637-942edc444171 // indirect
...
replace (
	...
	k8s.io/cli-runtime => k8s.io/cli-runtime v0.0.0-20240118214800-f0b7409cd6e5
