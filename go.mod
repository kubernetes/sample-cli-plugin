...
require (
	...
	k8s.io/cli-runtime v0.0.0-20260709110320-d08133dd2636
...
require (
	...
	k8s.io/api v0.0.0-20260709100004-a0e64618a579 // indirect
	k8s.io/apimachinery v0.0.0-20260708230628-806395eee25d // indirect
