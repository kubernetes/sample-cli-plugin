...
require (
	...
	k8s.io/cli-runtime v0.0.0-20231010154111-d37b3c0620ac
...
require (
	...
	k8s.io/api v0.0.0-20231010150909-f17c8484434a // indirect
	k8s.io/apimachinery v0.0.0-20231010150639-67d44f9b1fe3 // indirect
...
replace (
	...
	k8s.io/cli-runtime => k8s.io/cli-runtime v0.0.0-20231010154111-d37b3c0620ac
