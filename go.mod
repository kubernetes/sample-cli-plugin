...
require (
	...
	k8s.io/cli-runtime v0.0.0-20220614201533-01cc734f209a
...
require (
	...
	k8s.io/api v0.0.0-20220614194928-60387f6ceb7c // indirect
	k8s.io/apimachinery v0.0.0-20220614194717-c5be38573c73 // indirect
...
replace (
	...
	k8s.io/cli-runtime => k8s.io/cli-runtime v0.0.0-20220614201533-01cc734f209a
