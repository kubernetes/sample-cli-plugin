...
require (
	...
	k8s.io/cli-runtime v0.0.0-20230602184354-c1cf6e4e24ca
...
require (
	...
	k8s.io/api v0.0.0-20230527221710-63505c4e796f // indirect
	k8s.io/apimachinery v0.0.0-20230602181533-57a927096db7 // indirect
...
replace (
	...
	k8s.io/cli-runtime => k8s.io/cli-runtime v0.0.0-20230602184354-c1cf6e4e24ca
