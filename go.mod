...
require (
	...
	k8s.io/cli-runtime v0.0.0-20260619020253-38bbf491474f
...
require (
	...
	k8s.io/api v0.0.0-20260619005804-b846a6a65d1f // indirect
	k8s.io/apimachinery v0.0.0-20260619005300-111d7ab7ffaf // indirect
